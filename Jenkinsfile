...
def bootstrapImage(){
    ...
    try {
        ...
        isoTesters['Collections-DoubleLinkedList'] = { defineIsoTestStage("Collections-DoubleLinkedList", "CollectionsDoubleLinkedList", "\'Collections-DoubleLinkedList-Tests\'") }        
        parallel isoTesters
