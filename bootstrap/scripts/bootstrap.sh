...
wget https://github.com/guillep/PharoBootstrap/releases/download/v1.3/bootstrapImage.zip
...
./pharo Pharo.image ${REPOSITORY}/bootstrap/scripts/generateTraitsHermesFiles.st --quit
