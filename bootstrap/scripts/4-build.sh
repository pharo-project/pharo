...
${VM} "${COMPILER_IMAGE_NAME}.image" "${IMAGE_FLAGS}" loadHermes Collections-Atomic.hermes AST-Core.hermes Collections-Arithmetic.hermes Jobs.hermes ClassDefinitionPrinters.hermes System-SourcesCondenser.hermes --save --no-fail-on-undeclared
