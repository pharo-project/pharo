...
sudo ./vm/pharo -vm-display-null core.image st ../bootstrap/scripts/01-initialization/01-init.st --save --quit
sudo ./vm/pharo -vm-display-null core.image st ../bootstrap/scripts/01-initialization/02-initRPackageOrganizer.st --save --quit
...
sudo ./vm/pharo -vm-display-null core.image save monticello_bootstrap
sudo ./vm/pharo -vm-display-null monticello_bootstrap.image st st-cache/Monticello.st --save --quit
sudo ./vm/pharo -vm-display-null monticello_bootstrap.image st ../bootstrap/scripts/02-monticello-bootstrap/01-fixLocalMonticello.st --save --quit
sudo ./vm/pharo -vm-display-null monticello_bootstrap.image st ../bootstrap/scripts/02-monticello-bootstrap/02-bootstrapMonticello.st --save --quit
...
sudo ./vm/pharo -vm-display-null monticello_bootstrap.image save monticello
sudo ./vm/pharo -vm-display-null monticello.image st ../bootstrap/scripts/02-monticello-bootstrap/03-bootstrapMonticelloRemote.st --save --quit
zip monticello$SUFFIX.zip monticello.*

#Bootstrap Metacello
echo "[Metacello] Bootstrapping Metacello"
sudo ./vm/pharo -vm-display-null monticello.image save metacello
sudo ./vm/pharo -vm-display-null metacello.image st ../bootstrap/scripts/03-metacello-bootstrap/01-loadMetacello.st --save --quit
zip metacello$SUFFIX.zip metacello.*

echo "[Pharo] Reloading rest of packages"
sudo ./vm/pharo -vm-display-null metacello.image save Pharo
ln -s .. pharo-core #Required for the correct work of metacello baselines
sudo ./vm/pharo -vm-display-null Pharo.image eval "Metacello new baseline: 'IDE';repository: 'filetree://../src'; load" --save --quit
